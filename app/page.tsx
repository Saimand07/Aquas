...
// Modern Frosted Liquid Glass Navbar
function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b ${
        scrolled
          ? "h-16 bg-black/75 backdrop-blur-2xl border-white/[0.12] shadow-[0_4px_30px_rgba(0,0,0,0.5)]"
          : "h-20 bg-black/40 backdrop-blur-xl border-white/[0.06]"
      }`}
    >
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 h-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden sm:flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/[0.03] backdrop-blur-md border border-white/10 text-xs font-mono text-zinc-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-2">
              <Link
                ...
                className="h-9 px-5 flex items-center justify-center gap-1.5 text-xs rounded-xl hover:bg-[#b08d57] transition-all shadow-xl cursor-pointer"
              >
                <span>Console</span>
              ...
              <button
                ...
                className="h-9 px-3 text-xs rounded-xl hover:text-white hover:border-white/30 transition-colors cursor-pointer"
              >
                Sign Out
              </button>
            </div>
            ...
            <Link
              ...
              className="h-9 px-5 flex items-center justify-center gap-2 text-xs rounded-xl hover:bg-[#b08d57] transition-all shadow-xl cursor-pointer"
            >
              Launch App
            </Link>
          )}
...
export default function LandingPage() {
  ...
  return (
    <FluidParticlesBackground className="min-h-screen bg-[#070707] text-white selection:bg-[#b08d57] selection:text-black font-sans overflow-x-hidden">
      <div ref={containerRef} className="relative z-10 w-full">
        <Navbar />

        {/* 1. HERO SECTION (Liquid Glass Finish) */}
        <section className="relative min-h-[92vh] flex flex-col pt-36 pb-24 px-6 lg:px-12 max-w-[1400px] mx-auto justify-center text-center items-center">
          {/* Ambient Specular Glass Glow */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[650px] bg-gradient-to-br from-[#b08d57]/12 via-[#3fa96b]/08 to-transparent blur-[160px] rounded-full pointer-events-none z-0" />
          ...
          >
            {/* Eyebrow Pill */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.03] backdrop-blur-2xl border border-white/15 text-xs font-mono text-[#b08d57] shadow-[inset_0_1px_1px_rgba(255,255,255,0.2),0_8px_24px_rgba(0,0,0,0.3)]">
            ...
            {/* Subtitle */}
            <p className="text-lg sm:text-xl md:text-2xl text-zinc-300 max-w-2xl font-light leading-relaxed">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
              ...
              <button
                ...
                className="h-14 px-8 flex items-center justify-center gap-2.5 text-base rounded-2xl hover:bg-white/10 hover:border-white/40 transition-all backdrop-blur-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)] cursor-pointer"
              >
            ...
            <div className="flex flex-wrap justify-center gap-3 pt-6">
              {[
                ...
                <div
                  key={idx}
                  className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/[0.025] backdrop-blur-2xl border border-white/10 text-xs font-mono text-[#3fa96b] shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]"
                >
          ...
          {/* Live Activity Ribbon in Liquid Frosted Glass */}
          <div className="w-full mt-24 border-t border-white/[0.08] bg-black/40 backdrop-blur-2xl overflow-hidden py-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
            <motion.div 
              animate={{ x: ["0%", "-50%"] }}
        ...
        {/* 2. DEDICATED LIVE ZK VERIFICATION ENGINE SHOWCASE (Liquid Glass Cards) */}
        <section id="zk-engine" className="py-32 px-6 max-w-7xl mx-auto border-t border-white/[0.08]">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#3fa96b]/10 backdrop-blur-xl border border-[#3fa96b]/20 text-xs font-mono text-[#3fa96b] mb-4 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            {/* Simulator Card (Liquid Glass Premium Finish) */}
            <div className="lg:col-span-7">
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="p-8 md:p-10 bg-white/[0.025] hover:bg-white/[0.035] backdrop-blur-2xl border border-white/[0.12] rounded-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_16px_48px_rgba(0,0,0,0.6)] relative overflow-hidden transition-all duration-300"
              >
                ...
                <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 mb-6 font-mono text-xs space-y-3.5 shadow-inner">
                ...
                {demoState === "idle" && (
                  <button
                    ...
                    className="w-full py-4 rounded-xl flex items-center justify-center gap-2 text-sm shadow-2xl hover:bg-[#b08d57] transition-all cursor-pointer"
                  >
                ...
                {demoState === "proving" && (
                  <div className="w-full py-4 bg-white/[0.04] border border-white/15 rounded-xl flex items-center justify-center gap-3 text-[#b08d57] font-mono text-sm font-semibold backdrop-blur-xl">
                ...
                {demoState === "verified" && (
                  <motion.div 
                    ...
                    className="w-full p-6 bg-[#3fa96b]/10 backdrop-blur-2xl border border-[#3fa96b]/30 rounded-2xl"
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-xs font-mono">
                      {["✓ Active State Licensure", "✓ DEA Schedule II-V Rights", "✓ CME ≥50h Completed", "✓ Clean NPDB Record"].map(t => (
                        <div key={t} className="px-3 py-2 bg-black/60 border border-white/10 rounded-lg text-zinc-200">
                          {t}
                        </div>
                      ))}
                    </div>
            ...
            {/* Explanatory Architecture Cards (Liquid Glass Finish) */}
            <div className="lg:col-span-5 flex flex-col gap-4">
              {[
                {
                  icon: Key,
                  color: "text-[#b08d57]",
                  title: "1. Local Witness Secrecy",
                  desc: "Doctor credentials, private keys, and SSN remain strictly in the local browser. The witness never touches any external server."
                },
                {
                  icon: Cpu,
                  color: "text-[#3fa96b]",
                  title: "2. WASM Circuit Execution",
                  desc: "Compact ZK circuits evaluate validity, expiry dates, and authority signatures locally, producing an unforgeable SNARK proof."
                },
                {
                  icon: Database,
                  color: "text-[#b08d57]",
                  title: "3. Consensus Settlement",
                  desc: "Midnight nodes verify the ZK proof on-chain against public authority commitments, guaranteeing instant settlement."
                }
              ].map((step, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="p-6 bg-white/[0.02] hover:bg-white/[0.035] backdrop-blur-2xl border border-white/10 hover:border-white/20 rounded-2xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_8px_32px_rgba(0,0,0,0.3)] transition-all duration-300"
                  >
        ...
        {/* 3. CAPABILITIES GRID (Liquid Glass Finish) */}
        <section id="capabilities" className="py-32 px-6 max-w-7xl mx-auto border-t border-white/[0.08]">
          ...
          <p className="text-lg text-zinc-400 max-w-3xl mx-auto text-center mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <motion.div
                ...
                className="p-8 bg-white/[0.02] hover:bg-white/[0.04] backdrop-blur-2xl border border-white/[0.1] hover:border-white/25 rounded-3xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.12),0_12px_36px_rgba(0,0,0,0.4)] transition-all duration-300 flex flex-col justify-between gap-4 group"
              >
                <div>
                  <div className="flex items-center gap-4 mb-4">
                    <div className="p-3 bg-white/[0.04] border border-white/10 rounded-2xl group-hover:border-[#b08d57]/30 transition-colors">
                      <feat.icon className="w-6 h-6 text-[#b08d57]" />
                    </div>
                    <div>
                      <h3 className="font-bold text-lg text-white">{feat.title}</h3>
                      <p className="text-xs text-zinc-500 font-mono">{feat.subtitle}</p>
                    </div>
                  </div>
        ...
        <section id="architecture" className="py-32 px-6 max-w-7xl mx-auto border-t border-white/[0.08]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="p-10 border border-white/[0.1] bg-white/[0.02] hover:bg-white/[0.035] backdrop-blur-2xl rounded-3xl flex flex-col gap-6 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1),0_12px_36px_rgba(0,0,0,0.4)] transition-all"
            >
              <div className="w-14 h-14 rounded-2xl bg-red-500/10 flex items-center justify-center border border-red-500/20">
                <Lock className="w-6 h-6 text-red-400" />
              </div>
              <h3 className="text-2xl font-bold text-white">The Privacy Deficit</h3>
            ...
            >
              ...
              <h3 className="text-2xl font-bold text-white">The Multi-State Friction</h3>
              <p className="text-zinc-400 leading-relaxed">
        ...
        {/* 5. FINAL CTA (Liquid Glass Box) */}
        <section className="py-32 px-6 text-center border-t border-white/[0.08] relative overflow-hidden">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[400px] bg-[#3fa96b]/[0.04] blur-[120px] rounded-full pointer-events-none" />
          
          <div className="relative z-10 max-w-4xl mx-auto p-12 md:p-16 rounded-3xl bg-white/[0.02] backdrop-blur-2xl border border-white/15 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_20px_60px_rgba(0,0,0,0.6)] flex flex-col items-center">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight mb-6 text-white">Give your doctors privacy.</h2>
            <p className="text-zinc-400 max-w-xl text-base mb-10 leading-relaxed">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <Link
                ...
                className="h-14 px-9 flex items-center justify-center text-base rounded-2xl hover:bg-[#b08d57] transition-all shadow-2xl cursor-pointer"
              >
              ...
              <Link
                ...
                className="h-14 px-8 flex items-center justify-center text-base rounded-2xl hover:bg-white/10 transition-colors gap-2 cursor-pointer font-medium backdrop-blur-xl"
              >
        ...
        {/* 6. FOOTER (Liquid Glass Finish) */}
        <footer className="px-6 py-12 border-t border-white/[0.08] bg-black/40 backdrop-blur-xl">
          <div className="max-w-[1600px] mx-auto flex flex-col gap-12">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pt-8 border-t border-white/[0.08] text-xs text-zinc-500 font-mono">
              ...
              <div className="flex items-center gap-2 border border-white/10 px-3 py-1.5 rounded-lg bg-white/[0.02] backdrop-blur-md">
